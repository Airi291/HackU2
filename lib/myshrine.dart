...
class MyShrinePage extends StatelessWidget {
  @override
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // omamori.pngを横並びで3つ配置
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            // 1つ目のomamori.pngをクリックした場合
                            GestureDetector(
                              onTap: () {
                                // タップしたときにdetail.dartに遷移
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => OmamoriPage(), // detail.dartのページに遷移
                                  ),
                                );
                              },
                              child: Image.asset(
